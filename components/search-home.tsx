  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center w-full">
        ...
        >
          ...
          >
            <textarea
              ...
              className="w-full resize-none bg-transparent px-6 pt-5 pb-14 text-lg text-foreground placeholder:text-muted-foreground/50 focus:outline-none leading-relaxed"
        ...
        {/* Suggested queries */}
        <div
          className="mt-8 flex flex-wrap justify-center gap-2 max-w-[680px] animate-fade-up"
